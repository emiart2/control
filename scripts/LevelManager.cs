...
{
    [SerializeField] GameObject[] kafelki_rodzaje;
    ...
    void Start()
    {
        ...
        FindFirstObjectByType<WaypointsManager>().ZnajdzPunkty();
    }
    ...
    private void UmieszczanieKafelka(Vector3 pozycja, char rodzaj_kafelka, Punkt indeksy)
    {
        ...
        GameObject nowy_kafelek = Instantiate(kafelki_rodzaje[numer_kafelka]);
    ...
    {
        return kafelki_rodzaje[0].GetComponent<SpriteRenderer>().sprite.bounds.size.x; 
    }
